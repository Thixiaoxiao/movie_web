...
var vm = new Vue({
    ...
    methods: {
        jump_to_subject: function (key, id) {
            window.location.href='/querygetmovie.html?key='+key+'&id='+id
        },
        // 获取页数
        ...
        get_cate_movie: function (page) {
            ...
            if (cate_id != 'all') {
                ...
                axios.get(this.host + '/cates/' + cate_id + '/?page=' + page, {
                    responseType: 'json'
                })
                    .then(response => {
                        // 为 图片添加 详情页面的网址
